...
class Lot19OllamaSilentInstallTests(unittest.TestCase):
    ...
    def test_ollama_installer_suppresses_all_message_boxes(self) -> None:
        ...
        ollama_path = Path("C:/Users/test/AppData/Local/Programs/Ollama/ollama.exe")
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with (
                ...
                patch.object(adapter, "_find_executable", return_value=ollama_path),
                patch.object(adapter, "_component_version", return_value="0.33.3"),
            ):
